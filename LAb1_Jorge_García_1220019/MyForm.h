...
private: System::Void btnCambio_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	//lblTransformado->Text = System::Convert::ToString(recursividadObj->CambioDEC(txtNumT->Text, System::Convert::ToInt32(txtBO->Text), 0));
	lblTransformado->Text = System::Convert::ToString(recursividadObj->CambioB(System::Convert::ToInt32(txtNumT->Text), System::Convert::ToInt32(txtBD->Text)));
	stopWatch->Stop();
	System::Windows::Forms::MessageBox::Show("Tiempo de ejecución: " + System::Convert::ToString(stopWatch->Elapsed));
}
};
